...
var OptionList = (function () {
    ...
    OptionList.prototype._defaultTest = function (term, option) {
    ...
    Object.defineProperty(OptionList.prototype, "test", {
        get: function () {
            return this._test;
        },
        set: function (v) {
    ...
    OptionList.prototype.filter = function (term) {
        ...
        if (term.trim() === '') {
            ...
            this.options.forEach(function (option) {
                option.shown = _this.test(term, option);
                if (option.shown) {
                    anyShown = true;
                }
            });
